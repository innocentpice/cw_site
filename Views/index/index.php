    ...
    <div class="row" style="margin-top:4rem;">
      <div class="col-xs-12 text-center slideanim">
        ...
        <h4>
          ...
          ตั้งอยู่เลขที่ 29/2 หมู่ 1 ตําบลนาตาขวัญ อําเภอเมือง จังหวัดระยอง 21000 บนเนื้อที่จํานวน 5 ไร่ เป็นบริษัทของคนไทย ก่อตั้งโดย คุณณัชพล ศรีดา และคุณชัยวัฒน์ บุญทอง ในปี พ.ศ. 2550 ทุนจดทะเบียน 2,000,000 บาท </h4><br>
        <h4>
